...
| [**wcmd**](https://github.com/Jeffrey0117/wcmd) | 使用 linux 的時候也可以用 windows 指令，不需要學，懶人專用 |
| [**typee**](https://github.com/Jeffrey0117/typee) | 一個 bat 檔案讓你用不同編輯器打開 |
| [**brozz**](https://github.com/Jeffrey0117/brozz) | 超乾淨的瀏覽器視窗，適合截圖或是看影片 |

### 🔮 Claude 設定與工具

| 專案 | 說明 |
|------|------|
| [**saveclaudenode**](https://github.com/Jeffrey0117/saveclaudenode) | 不要讓 Claude Code 每次殺 node 殺到自己，裡面有附上 hook，也有保護的程式 |
| [**vscode-claude-electron-fix**](https://github.com/Jeffrey0117/vscode-claude-electron-fix) | 在 VSCode 裡面用 Claude extension 開 Electron 會遇到的問題解決方案 |

### 🤖 AI 相關

| 專案 | 說明 |
|------|------|
| [**meei**](https://github.com/Jeffrey0117/meei) | 我自己寫程式要串 AI 就用這個，把 env 放這專案的本地後，叫 AI 讀 meei 就超好用了 |
| [**gitgpt**](https://github.com/Jeffrey0117/gitgpt) | 實驗性想寫一個 GPT 的 CLI 程式，玩玩而已 |
| [**monus**](https://github.com/Jeffrey0117/monus) | 實驗性想要試試看做一個 manus 的工具，效果很普通 |
...
| [**biaodian**](https://github.com/Jeffrey0117/biaodian) | 不使用模型使用規則去幫語音轉文字加上標點，可以省時間省效能 |
| [**Hanzi_ASR**](https://github.com/Jeffrey0117/Hanzi_ASR) | 我把我調整 FunASR 弄到跟 Sherpa-ONNX 差不多快的一個成果 |
...
| [**Text2Img**](https://github.com/Jeffrey0117/Text2Img) | 丟文字變成圖片可複製，社群用，很多開源字型 |
...
| 專案 | 說明 |
|------|------|
| [**ThreadGram**](https://github.com/Jeffrey0117/ThreadGram) | 打造類似 IG 介面的 Threads，還沒弄爬蟲所以未完成 |
...
| [**Nextjs-ptt-beauty**](https://github.com/Jeffrey0117/Nextjs-ptt-beauty) | 爬蟲爬 PTT 網站的美女圖，就是個練習網站 |
| [**static-leaf-builder**](https://github.com/Jeffrey0117/static-leaf-builder) | 一個可以當 Chrome 新分頁的網頁，自定義網頁 icon 按鈕的搜尋頁 |
